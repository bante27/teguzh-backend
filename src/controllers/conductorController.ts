...
export const verifyTicket = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  try {
...
export const updateBusLocation = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  try {
...
export const getBusLocation = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  try {
