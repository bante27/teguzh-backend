...
import * as dynamicFare from '../services/dynamicFare';
import * as qrGenerator from '../services/qrGenerator';
import * as telebirrService from '../services/telebirrService';
import mongoose from 'mongoose';

export const estimateFare = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  try {
...
export const passengerBookPage = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  try {
...
export const bookTicket = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  try {
...
export const successPage = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  try {
...
export const simulatePaymentPage = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  try {
    const token = req.query.token as string;
    if (!token) {
...
export const verifySimulate = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  try {
...
export const telebirrWebhook = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  try {
...
export const getActiveTicket = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  try {
